...
class InferFacultyKeyTests(unittest.TestCase):
    def test_commerce(self):
        ...
        self.assertEqual(
            _infer_faculty_key("Commerce (Information Systems)"), "uct_commerce"
        )

    def test_engineering(self):
        self.assertEqual(
            _infer_faculty_key("Bachelor of Science in Engineering"), "uct_ebe"
        )
    ...
    def test_humanities(self):
        self.assertEqual(
            _infer_faculty_key("Bachelor of Social Science"), "uct_humanities"
        )
        self.assertEqual(
            _infer_faculty_key("Bachelor of Social Work"), "uct_humanities"
        )
