...
class TestExclusionRisk(unittest.TestCase):
    ...
    def _create_results(
        self, count: int, passed: int, senior: int
    ) -> list[CourseResult]:
        results = []
    ...
    def _create_student(
        self, attempted: int, passed: int, senior: int = 0
    ) -> StudentRecord:
    ...
    def test_missing_programme(self):
        risk = _compute_exclusion_risk(
            self._create_student(5, 5), self.catalogue, "unknown_prog"
        )
    ...
    def test_regular_year_1_not_at_risk(self):
        self.assertFalse(
            _compute_exclusion_risk(
                self._create_student(8, 5), self.catalogue, "regular_ba_bsocsc"
            ).at_risk
        )

    def test_regular_year_1_at_risk(self):
        risk = _compute_exclusion_risk(
            self._create_student(8, 4), self.catalogue, "regular_ba_bsocsc"
        )
    ...
    def test_regular_year_2_not_at_risk(self):
        self.assertFalse(
            _compute_exclusion_risk(
                self._create_student(16, 9), self.catalogue, "regular_ba_bsocsc"
            ).at_risk
        )

    def test_regular_year_2_at_risk(self):
        risk = _compute_exclusion_risk(
            self._create_student(16, 8), self.catalogue, "regular_ba_bsocsc"
        )
        self.assertTrue(risk.at_risk)
    ...
    def test_regular_year_3_not_at_risk(self):
        self.assertFalse(
            _compute_exclusion_risk(
                self._create_student(24, 13, 2), self.catalogue, "regular_ba_bsocsc"
            ).at_risk
        )

    def test_regular_year_3_at_risk_passed(self):
        risk = _compute_exclusion_risk(
            self._create_student(24, 12, 2), self.catalogue, "regular_ba_bsocsc"
        )
        self.assertTrue(risk.at_risk)
    ...
    def test_regular_year_3_at_risk_senior(self):
        risk = _compute_exclusion_risk(
            self._create_student(24, 13, 1), self.catalogue, "regular_ba_bsocsc"
        )
        self.assertTrue(risk.at_risk)
    ...
    def test_regular_year_3_at_risk_both(self):
        risk = _compute_exclusion_risk(
            self._create_student(24, 12, 1), self.catalogue, "regular_ba_bsocsc"
        )
        self.assertTrue(risk.at_risk)
    ...
    def test_regular_year_4(self):
        risk = _compute_exclusion_risk(
            self._create_student(25, 12, 1), self.catalogue, "regular_ba_bsocsc"
        )
        self.assertTrue(risk.at_risk)
        self.assertEqual(len(risk.reasons), 2)
    ...
    def test_extended_year_1_not_at_risk(self):
        self.assertFalse(
            _compute_exclusion_risk(
                self._create_student(8, 4), self.catalogue, "extended_ba_bsocsc"
            ).at_risk
        )
    ...
    def test_extended_year_1_at_risk(self):
        self.assertTrue(
            _compute_exclusion_risk(
                self._create_student(8, 3), self.catalogue, "extended_ba_bsocsc"
            ).at_risk
        )
    ...
    def test_extended_year_2_not_at_risk(self):
        self.assertFalse(
            _compute_exclusion_risk(
                self._create_student(16, 8), self.catalogue, "extended_ba_bsocsc"
            ).at_risk
        )
    ...
    def test_extended_year_2_at_risk(self):
        self.assertTrue(
            _compute_exclusion_risk(
                self._create_student(16, 7), self.catalogue, "extended_ba_bsocsc"
            ).at_risk
        )
    ...
    def test_extended_year_3_not_at_risk(self):
        self.assertFalse(
            _compute_exclusion_risk(
                self._create_student(24, 12, 2), self.catalogue, "extended_ba_bsocsc"
            ).at_risk
        )
    ...
    def test_extended_year_3_at_risk(self):
        self.assertTrue(
            _compute_exclusion_risk(
                self._create_student(24, 12, 1), self.catalogue, "extended_ba_bsocsc"
            ).at_risk
        )
    ...
    def test_extended_year_4_not_at_risk(self):
        self.assertFalse(
            _compute_exclusion_risk(
                self._create_student(25, 15, 4), self.catalogue, "extended_ba_bsocsc"
            ).at_risk
        )

    def test_extended_year_4_at_risk(self):
        risk = _compute_exclusion_risk(
            self._create_student(25, 14, 4), self.catalogue, "extended_ba_bsocsc"
        )
        self.assertTrue(risk.at_risk)
        self.assertEqual(len(risk.reasons), 1)
