...
def annual_progress(
    first: int, concession: int | None, later: int, years: int, label: str
) -> list[dict[str, Any]]:
    rules: list[dict[str, Any]] = [
        {
            ...
            "year": 1,
            "minimum": first,
            "concession_minimum": concession,
            "label": f"{label}: first-year progression",
        }
    ]
            ...
            "curriculum_rules": [
                {
                    ...
                    "id": "first_class_cwa",
                    "label": "Cumulative credit-weighted average",
                    "minimum_average": 75,
                },
                {
                    "type": "minimum_mark",
                    "id": "first_class_project",
                    "label": f"Research project {project_code}",
                    "course_codes": [project_code],
                    "minimum_mark": 75,
                },
            ],
        },
...
def main() -> None:
        ...
        for raw in route_rows:
            ...
            if code not in facts:
                facts[code] = {
                    ...
                    "nqf_level": int(raw["level"]),
                    "prerequisites": [],
                    "prerequisites_verified": int(raw["level"]) == 5,
                    "co_requisites": [],
                    "offered": semester_from_code(code),
                    ...
                    "source": {
                        ...
                        "section": "Programme curriculum table",
                    },
                    "general_elective": False,
                    "counts_towards_general_degree": True,
                    "counts_as_humanities": False,
    ...
    african_studies_codes = {
        code
        for code, row in human_by_code.items()
        if code.startswith(("AFS", "ANS"))
        or (
            code.startswith("ASL")
            and not any(
                token in row.get("name", "").lower()
                for token in ("language", "linguist", "sociolingu")
            )
        )
    }
    broad_humanities_codes = {
        code for code in human_by_code if code.startswith(("AGE", "HST", "PHI", "SOC"))
    }
    ...
    for code in chemical_humanities_allowed_codes:
        ...
        sibling = next(
            (
                value
                for sibling_code, value in {**facts, **human_by_code}.items()
        ...
        if code not in facts:
            facts[code] = {
                ...
                "source": {
                    "document": SOURCE_DOCUMENT,
                    "page": 37,
                    "section": "Chemical Engineering advanced electives",
                },
                "general_elective": False,
                "counts_towards_general_degree": True,
                "counts_as_humanities": False,
    ...
    chem_elective_rules = [
        ...
        credit_pool(
            "science_level6",
            "Science elective credits at NQF level 6 or above",
            chem_science,
            24,
            filters={"nqf_levels": [6, 7, 8]},
        ),
        manual(
        ...
        credit_pool(
            ...
            "Advanced Engineering elective credits",
            chem_advanced,
            32,
        ),
        manual(
        ...
        credit_pool(
            "advanced_level8",
            "Advanced Engineering credits at NQF level 8",
            chem_advanced,
            16,
            filters={"nqf_levels": [8]},
        ),
        approved_credit_pool(
            "free_elective",
    ...
    programmes["bas"] = programme(
        ...
        curriculum_rules=[
            manual(
                "bas_credit_conflict",
                "Published BAS credit reconciliation",
        ...
        progression_rules=[
            {
                "type": "failed_any",
                "label": "No failed BAS major course",
                "course_codes": [
                    "APG1003W",
                    "APG1020W",
                    "APG2021W",
                ...
                "curriculum_rules": [
                    {
                        "type": "minimum_mark",
                        "id": "studio3",
                        "label": "Design & Theory Studio III",
                        "course_codes": ["APG3037W"],
                        "minimum_mark": 75,
                    },
                    {
                        "type": "minimum_mark",
                        "id": "earlier_studio",
                        "label": "Earlier Design & Theory Studio examination",
                        "course_codes": ["APG1020W", "APG2039W"],
                        "minimum_mark": 70,
                    },
                    {
                        "type": "passed_mark_count",
                        "id": "additional_firsts",
                        "label": "Three additional first-class BAS passes",
                        "required": 3,
                        "minimum_mark": 75,
                        "exclude_course_codes": ["APG1020W", "APG2039W", "APG3037W"],
                    },
                ],
            }
        ],
    ...
    for key, route_key, name, code, years, total, page, availability in [
        (
            "geomatics_surveying_4",
            "geom_survey4",
            "BSc Geomatics — Surveying (4-year)",
            "EB019APG09",
            4,
            519,
            25,
        ...
        (
            "geomatics_surveying_5",
            "geom_survey5",
            "BSc Geomatics — Surveying (5-year ASPECT)",
            "EB819APG09",
            5,
            519,
            26,
        ...
        (
            "geomatics_geoinformatics_cs_4",
            "geom_geo_cs4",
            "BSc Geomatics — Geoinformatics/Computer Science (4-year)",
            "EB019APG11",
            4,
            519,
            28,
        ...
        (
            "geomatics_geoinformatics_cs_5",
            "geom_geo_cs5",
            "BSc Geomatics — Geoinformatics/Computer Science (5-year ASPECT)",
            "EB819APG11",
            5,
            519,
            30,
        ...
        (
            "geomatics_geoinformatics_egs_4",
            "geom_geo_egs4",
            "BSc Geomatics — Geoinformatics/EGS (4-year, continuing students)",
            "EB019APG11",
            4,
            576,
            31,
        ...
        (
            "geomatics_geoinformatics_egs_5",
            "geom_geo_egs5",
            "BSc Geomatics — Geoinformatics/EGS (5-year, continuing students)",
            "EB819APG11",
            5,
            576,
            32,
        ...
        if "_egs_" in key:
            ...
            rules.append(
                choose_rule(
                    "egs_level7",
                    "Choose two approved EGS level-7 electives",
                    egs_options,
                    2,
                )
            )
        ...
        rules.append(
            manual(
                "geomatics_transition",
                "Cohort transition confirmation",
        ...
        programmes[key] = programme(
            ...
            availability=availability,
            availability_note=(
                "This EGS specialisation is being phased out and is not open to new 2026 entrants."
            ...
            progression_rules=[
                {
                    ...
                    "year": 1,
                    "minimum": first,
                    "concession_minimum": 32 if years == 5 else 40,
                    "label": "First-year Geomatics progression",
                },
                {
                    "type": "manual",
                    "label": "Rolling two-year credit rule",
                    "note": f"Subsequent progression uses a rolling two-year threshold ({192 if years == 5 else 224} credits) and transfer/re-registration variants that require year-labelled records.",
                },
            ],
            award_rules=geom_awards,
            notes=[
                "Fieldwork, practical performance and professional registration conditions remain operational requirements."
            ],
        )

    programmes["chemical_engineering_4"] = programme(
        "BSc Engineering — Chemical Engineering (4-year)",
        "EB001CHE01",
        560,
        4,
        chem_core4,
        ...
        progression_rules=annual_progress(
            102, 66, 108, 4, "Chemical Engineering 4-year"
        ),
        award_rules=engineering_awards("CHE4045Z", 4),
        notes=[
            "Mandatory reassessment replaces supplementary examinations in specified Chemical Engineering courses."
        ],
    )
    programmes["chemical_engineering_5"] = programme(
        "BSc Engineering — Chemical Engineering (5-year ASPECT)",
        "EB801CHE01",
        560,
        5,
        chem_core5,
    ...
    civil_paths = {
        ...
        "legacy_576": pathway(
            "Legacy 576-credit curriculum",
            rules=[
                {
                    "type": "credits",
                    "id": "legacy_credits",
                    "label": "Legacy curriculum credits",
                    "required": 576,
                }
            ],
            status="provisional",
    ...
    programmes["civil_engineering_4"] = programme(
        "BSc Engineering — Civil Engineering (4-year)",
        "EB002CIV01",
        560,
        4,
        codes("civil4"),
        ...
        curriculum_rules=[
            approved_credit_pool(
                "civil_elective",
                "Approved Civil Engineering elective",
                18,
                transcript_only=True,
                allow_unlisted_transcript_courses=True,
        ...
        pathways=civil_paths,
        pathway_required=True,
        default_pathway_key="current_560",
    ...
    programmes["civil_engineering_5"] = programme(
        "BSc Engineering — Civil Engineering (5-year ASPECT)",
        "EB802CIV01",
        560,
        5,
        codes("civil5"),
    ...
    programmes["construction_studies"] = programme(
        ...
        curriculum_rules=[
            manual(
                "construction_credit_conflict",
                "Published credit reconciliation",
                "FB3.2 requires at least 432 credits, while the printed prescribed-course table totals 422 credits. Faculty confirmation of the missing/transition credit component is required.",
                status="conflict",
            )
        ],
        progression_rules=[
            {
                ...
                "year": 1,
                "minimum": 100,
                "concession_minimum": 54,
                "label": "End of first year",
            },
            {
                "type": "cumulative_credits",
                "year": 2,
                "minimum": 200,
                "label": "End of second year",
            },
            {
                "type": "cumulative_credits",
                "year": 3,
                "minimum": 325,
                "label": "End of third year",
            },
            {
                "type": "cumulative_credits",
                "year": 4,
                "minimum": 432,
                "label": "End of fourth year",
            },
        ],
        award_rules=[
            {
    ...
    programmes["property_studies"] = programme(
        ...
        curriculum_rules=[
            manual(
                "property_credit_conflict",
                "Published credit reconciliation",
                "The programme text requires at least 452 credits, while the printed prescribed-course table totals fewer credits. Faculty confirmation of the remaining approved component is required.",
                status="conflict",
            )
        ],
        progression_rules=[
    ...
    eee_specs = [
        (
            ...
            "ee4",
            "BSc Engineering — Electrical Engineering (4-year)",
            "EB009EEE01",
            4,
            48,
        ),
        (
            ...
            "ee5",
            "BSc Engineering — Electrical Engineering (5-year ASPECT)",
            "EB809EEE01",
            5,
            49,
        ),
        (
            "electrical_computer_engineering_4",
            "ece4",
            "BSc Engineering — Electrical & Computer Engineering (4-year)",
            "EB022EEE02",
            4,
            52,
        ),
        (
            "electrical_computer_engineering_5",
            "ece5",
            "BSc Engineering — Electrical & Computer Engineering (5-year ASPECT)",
            "EB822EEE02",
            5,
            54,
        ),
        (
            "mechatronics_engineering_eee_4",
            "mechatronics_eee4",
            "BSc Engineering — Mechatronics (Electrical Engineering, 4-year)",
            "EB011EEE05",
            4,
            56,
        ),
        (
            "mechatronics_engineering_eee_5",
            "mechatronics_eee5",
            "BSc Engineering — Mechatronics (Electrical Engineering, 5-year ASPECT)",
            "EB811EEE05",
            5,
            58,
        ),
    ...
    for key, row_key, name, code, years, page in eee_specs:
        ...
        if key.startswith("electrical_engineering"):
            ...
            rules += [
                choose_rule(
                    "elective_primary",
                    "At least one primary Electrical Engineering elective",
                    primary,
                    1,
                ),
                credit_pool(
                    "elective_total",
                    "Fourth-year elective core credits",
                    option_codes,
                    48,
                ),
            ]
            ...
            rules += [
                choose_rule(
                    "third_year_options", "Choose two third-year options", mid, 2
                ),
                choose_rule(
                    "final_primary",
                    "At least two ECE elective-core courses",
                    final_primary,
                    2,
                ),
                approved_credit_pool(
            ...
            rules += [
                choose_rule(
                    "elective_primary",
                    "Choose at least two Mechatronics elective-core courses",
                    primary,
                    2,
                ),
                credit_pool(
                    "elective_total", "Final elective-core credits", option_codes, 48
                ),
            ]
        core = [
            c for c in all_codes if c not in placeholder and c not in set(option_codes)
        ]
        ...
        paths = {
            ...
            "legacy_576": pathway(
                ...
                rules=[
                    ...
                    manual(
                        "legacy_equivalents",
                        "Legacy complementary-course equivalents",
                        "Students on the 576-credit curriculum may need outstanding ASL1200S/CON2026S or approved equivalents.",
                    ),
                ],
                status="provisional",
                page=page,
        ...
        programmes[key] = programme(
            ...
            default_pathway_key="current_560",
            progression_rules=annual_progress(
                96 if years == 4 else 60,
                66 if years == 4 else 48,
                current_later,
                years,
                name,
            ),
            ...
            notes=[
                f"The legacy 576-credit curriculum uses a {legacy_later}-credit subsequent-year progression threshold; the current route uses {current_later}."
            ],
        )
    ...
    mechanical_specs = [
        (
            ...
            "mech4",
            "BSc Engineering — Mechanical Engineering (4-year)",
            "EB005MEC01",
            4,
            61,
            27,
        ...
        (
            ...
            "mech5",
            "BSc Engineering — Mechanical Engineering (5-year ASPECT)",
            "EB805MEC01",
            5,
            63,
            27,
        ...
        (
            "mechanical_mechatronic_engineering_4",
            "mechmech4",
            "BSc Engineering — Mechanical & Mechatronic Engineering (4-year)",
            "EB010MEC05",
            4,
            65,
            15,
        ...
        (
            "mechanical_mechatronic_engineering_5",
            "mechmech5",
            "BSc Engineering — Mechanical & Mechatronic Engineering (5-year ASPECT)",
            "EB810MEC05",
            5,
            67,
            15,
    ...
    for key, row_key, name, code, years, page, open_credits in mechanical_specs:
        ...
        programmes[key] = programme(
            ...
            default_pathway_key="current_560",
            progression_rules=annual_progress(
                116 if years == 4 else 96,
                90 if years == 4 else 70,
                116 if years == 4 else 96,
                years,
                name,
            ),
    ...
    restricted_routes = {
        "chemical_engineering_transfer_conversion": (
            "Chemical Engineering — transferee/conversion route",
            "EB001CHE06",
            560,
            3,
            39,
            chem_core4,
            "Prior qualification credits, CHE1001P and individual exemption decisions must be confirmed.",
        ),
        "chemical_engineering_uot_access": (
            "Chemical Engineering — University of Technology access route",
            "EB001CHE06",
            560,
            3,
            40,
            chem_core4,
            "Admission, exemption and the 436-credit access curriculum depend on an approved prior diploma record.",
        ),
        "civil_engineering_uot_access": (
            "Civil Engineering — University of Technology transferee route",
            "EB002CIV01",
            560,
            3,
            45,
            codes("civil4"),
            "The department must approve transfer credits and the resulting individual curriculum.",
        ),
        "electrical_engineering_uot_access": (
            "Electrical Engineering programmes — University of Technology access",
            "EB009EEE01",
            560,
            3,
            61,
            [],
            "Admission and course exemptions are individually determined from the prior diploma and cannot be inferred from the UCT transcript alone.",
        ),
        "mechanical_engineering_uot_access": (
            "Mechanical Engineering programmes — University of Technology access",
            "EB005MEC01",
            560,
            3,
            69,
        ...
        programmes[key] = programme(
            ...
            curriculum_rules=[
                manual(
                    ...
                    "Approved individual transfer curriculum",
                    note,
                )
            ],
            progression_rules=[
                {
                    "type": "manual",
                    "label": "Transfer-specific progression",
                    "note": "Faculty progression must be applied to the formally approved transfer curriculum.",
                }
            ],
        )
    ...
    collect(programmes)
    used.update(
        code for p in programmes.values() for code in p.get("required_courses", [])
    )
