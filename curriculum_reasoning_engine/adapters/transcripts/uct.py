"""UCT transcript adapter.

This module preserves the legacy `engine.parser` behaviour exactly. It extracts
facts only; curriculum status, credit recognition, and pass/fail interpretation
...
def parse_grade(grade_str: str) -> str | None:
...
class UCTTranscriptAdapter:
    """Parse UCT transcript text or PDFs into the current StudentRecord."""

    adapter_id = "uct_transcript"
    institution_id = "uct"
