...
from .progression import (
    AccumulatedProgressionMetricResult as AccumulatedProgressionMetricResult,
)

# Preserve private import paths while progression owns each implementation.
from .progression import (
    AccumulatedProgressionMetricSpec as AccumulatedProgressionMetricSpec,
)
from .progression import (
    CourseRequirementCompletionSpec as CourseRequirementCompletionSpec,
)
from .progression import (
    FailedProgressionMetricResult as FailedProgressionMetricResult,
)
from .progression import (
    FailedProgressionMetricSpec as FailedProgressionMetricSpec,
)
from .progression import (
    FormalStageRepeatResult as FormalStageRepeatResult,
)
from .progression import (
    FormalStageRepeatSpec as FormalStageRepeatSpec,
)
from .progression import (
    ProgressionConditionResult as ProgressionConditionResult,
)
from .progression import (
    ProgressionConsequence as ProgressionConsequence,
)
from .progression import (
    ProgressionPolicyAssessment as ProgressionPolicyAssessment,
)
from .progression import (
    ProgressionPolicyResult as ProgressionPolicyResult,
)
from .progression import (
    ProgressionRatioResult as ProgressionRatioResult,
)
from .progression import (
    ProgressionRatioSelectorSpec as ProgressionRatioSelectorSpec,
)
from .progression import (
    ProgressionRatioSpec as ProgressionRatioSpec,
)
from .progression import (
    RepeatedItemFailureResult as RepeatedItemFailureResult,
)
from .progression import (
    RepeatedItemFailureSpec as RepeatedItemFailureSpec,
)
from .progression import (
    RequiredCoursePoolCompletionSpec as RequiredCoursePoolCompletionSpec,
)
from .progression import (
    _accumulated_metric_messages as _accumulated_metric_messages,
)
from .progression import (
    _accumulated_metric_value as _accumulated_metric_value,
)
from .progression import (
    _accumulated_progression_metric_spec as _accumulated_progression_metric_spec,
)
from .progression import (
    _completion_progression_result as _completion_progression_result,
)
from .progression import (
    _contextual_failed_metric_selection as _contextual_failed_metric_selection,
)
from .progression import (
    _course_requirement_completion_spec as _course_requirement_completion_spec,
)
from .progression import (
    _course_requirement_condition_result as _course_requirement_condition_result,
)
from .progression import (
    _evaluate_accumulated_progression_metric as _evaluate_accumulated_progression_metric,
)
from .progression import (
    _evaluate_failed_progression_metric as _evaluate_failed_progression_metric,
)
from .progression import (
    _evaluate_formal_stage_repeat as _evaluate_formal_stage_repeat,
)
from .progression import (
    _evaluate_progression_all_of as _evaluate_progression_all_of,
)
from .progression import (
    _evaluate_progression_condition as _evaluate_progression_condition,
)
from .progression import (
    _evaluate_progression_policy as _evaluate_progression_policy,
)
from .progression import (
    _evaluate_progression_ratio as _evaluate_progression_ratio,
)
from .progression import (
    _evaluate_repeated_item_failure as _evaluate_repeated_item_failure,
)
from .progression import (
    _failed_metric_condition_result as _failed_metric_condition_result,
)
from .progression import (
    _failed_metric_context_target as _failed_metric_context_target,
)
from .progression import (
    _failed_metric_messages as _failed_metric_messages,
)
from .progression import (
    _failed_metric_value as _failed_metric_value,
)
from .progression import (
    _failed_progression_metric_spec as _failed_progression_metric_spec,
)
from .progression import (
    _formal_stage_repeat_condition_result as _formal_stage_repeat_condition_result,
)
from .progression import (
    _formal_stage_repeat_messages as _formal_stage_repeat_messages,
)
from .progression import (
    _formal_stage_repeat_spec as _formal_stage_repeat_spec,
)
from .progression import (
    _matches_accumulated_progression_filters as _matches_accumulated_progression_filters,
)
from .progression import (
    _matches_failed_progression_filters as _matches_failed_progression_filters,
)
from .progression import (
    _matches_progression_ratio_filters as _matches_progression_ratio_filters,
)
from .progression import (
    _matches_progression_ratio_population as _matches_progression_ratio_population,
)
from .progression import (
    _progression_condition_messages as _progression_condition_messages,
)
from .progression import (
    _progression_consequence as _progression_consequence,
)
from .progression import (
    _progression_policy_assessment as _progression_policy_assessment,
)
from .progression import (
    _progression_policy_messages as _progression_policy_messages,
)
from .progression import (
    _progression_policy_unsupported as _progression_policy_unsupported,
)
from .progression import (
    _progression_ratio_base_items as _progression_ratio_base_items,
)
from .progression import (
    _progression_ratio_condition_result as _progression_ratio_condition_result,
)
from .progression import (
    _progression_ratio_messages as _progression_ratio_messages,
)
from .progression import (
    _progression_ratio_selector_spec as _progression_ratio_selector_spec,
)
from .progression import (
    _progression_ratio_selector_value as _progression_ratio_selector_value,
)
from .progression import (
    _progression_ratio_spec as _progression_ratio_spec,
)
from .progression import (
    _progression_ratio_triggers_risk as _progression_ratio_triggers_risk,
)
from .progression import (
    _repeated_item_failure_identity as _repeated_item_failure_identity,
)
from .progression import (
    _repeated_item_failure_messages as _repeated_item_failure_messages,
)
from .progression import (
    _repeated_item_failure_spec as _repeated_item_failure_spec,
)
from .progression import (
    _required_course_pool_completion_spec as _required_course_pool_completion_spec,
)
from .progression import (
    _required_course_pool_condition_result as _required_course_pool_condition_result,
)
from .progression import (
    _resolve_progression_ratio_identity as _resolve_progression_ratio_identity,
)
from .progression import (
    _result_context_evidence_matches_target as _result_context_evidence_matches_target,
)
from .progression import (
    _result_context_pathway_applies as _result_context_pathway_applies,
)
from .progression import (
    _stage_repeat_evidence_matches as _stage_repeat_evidence_matches,
)
from .progression import (
    _unsupported_progression_condition_result as _unsupported_progression_condition_result,
)
